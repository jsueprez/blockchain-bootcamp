...
const hdkey = require("ethereumjs-wallet/hdkey") //generate a private key from the hex seed
const Wallet = require('ethereumjs-wallet') //generate the public key
const keccak256 = require('js-sha3').keccak256; //Deriving an Ethereum address from a public key requires an additional hashing algorithm
const EthereumTx = require('ethereumjs-tx') // Sign transaction in the browser
...
//generate a seed from which to generate a private key
