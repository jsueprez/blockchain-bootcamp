...
// hash has to be lower than Difficulty(Number of leading (on the left) zeros 0` of the hash)
// THe more leading 0 there are, the lower that hash value is
var difficulty = 10;
